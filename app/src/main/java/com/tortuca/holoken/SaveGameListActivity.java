...
public class SaveGameListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (theme == GridView.THEME_LIGHT)
            saveButton.setTextColor(ContextCompat.getColorStateList(this,R.color.text_button));
        else if (theme == GridView.THEME_DARK)
            saveButton.setTextColor(ContextCompat.getColorStateList(this,R.color.text_button_dark));
